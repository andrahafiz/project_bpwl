	    ...
	    <div class="container">
	        <div class="row">
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ?>
	                <!-- <a href="..\contoh\public\pages\tables\images\Fasilitas\<?php echo $row[a2] ?>" class="img-gal">
	                                            <div class="" relative">
	                                                <div class="overlay overlay-bg"></div>
	                                                <div class="relative">
	                                                    <img class="img-fluid" src="..\contoh\public\pages\tables\images\Fasilitas\<?php echo $row[2] ?>" alt="">
	                                                </div>
	                                            </div>
	                                        </a> -->
	                <div class="col-lg-4">
