...
<body>
    ...
    $id_fasilitas = $_POST['idfasilitas'];
    ...
    if (move_uploaded_file($tmpname_logo, $lokasi . $nama_logo)) {
        ...
        if ($uploadstatus == 0) {
            ...
            //upload ke tabel ukm
            $query2 = "INSERT INTO `fasilitas` (`id_fasilitas`, `nama_fasilitas`, `foto_fasilitas`) 
                        VALUES ('$id_fasilitas', '$nama_fasilitas', '$nama_logo')";
            ...
            if (!$query) {
                ...
                echo "<script>alert('Insert Data $nama Berhasil'); window.location.href = '../../index.php?slink=pages/tables/fasilitas_data.php&status=succes_add';1</script>";
            }
        }
    } else {
