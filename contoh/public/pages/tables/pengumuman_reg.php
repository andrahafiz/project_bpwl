...
<body>
    ...
    $id_pengumuman = $_POST['idpengumuman'];
    $judul_pengumuman = $_POST['judulpengumuman'];
    $isi_pengumuman = $_POST['isipengumuman'];
    ...
    if (move_uploaded_file($tmpname_logo, $lokasi . $nama_logo)) {
        ...
        if ($uploadstatus == 0) {
            ...
            //upload ke tabel ukm
            $query2 = "INSERT INTO `pengumuman` (`id_pengumuman`, `judul_pengumuman`, `isi_pengumuman`, `foto_pengumuman`) 
                        VALUES ('$id_pengumuman', '$judul_pengumuman', '$isi_pengumuman', '$nama_logo')";
