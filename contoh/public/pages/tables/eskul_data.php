                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo "$row[1]"; ?>
                                    <td> <img src="pages/tables/images/Ekstrakulikuler/<?php echo "$row[2]"; ?> " alt="Logo <?php echo "$row[2]"; ?> " class="img-thumbnail" width=100px"></td>
                                    <td colspan="2" class="align-center">
                                       <a href="index.php?slink=pages/tables/eskul_hapus.php&id=<?php echo $row[0] ?>">
